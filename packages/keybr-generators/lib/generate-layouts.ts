...
for (const [id, layout] of [
  ...
  ["et_ee", importCldr("cldr-keyboards-43.0/keyboards/windows/et-t-k0-windows.xml")],
  ...
  ["ja_jp", importKeymap("layouts/ja_jp.json")],
  ...
  ["sa_inscript", importCldr("cldr-keyboards-43.0/keyboards/windows/hi-t-k0-windows.xml")],
